...
export const PORTABL_ORGANIZATION_ID = process.env.NEXT_PUBLIC_PORTABL_ORGANIZATION_ID || '';
...
export const PORTABL_PASSPORT_DOMAIN = process.env.NEXT_PUBLIC_PORTABL_PASSPORT_DOMAIN || '';
